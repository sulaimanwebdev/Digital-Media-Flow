  ...
  return (
    <>
     ...
     <div className="relative z-10 w-full mx-auto max-w-[1300px] pt-[150px]">
      ...
      <div className="w-full max-w-[1000px] mx-auto pb-8 bg-white px-3 rounded-xl mt-[100px] flex justify-between gap-5">
        ...
        <div className="text-center">
            <img src="/images/person2.png" alt="person" className='mx-auto w-[100px] transform -translate-y-1/2' />
            <div className='-mt-6'>
            <div className='text-[20px] text-[#111029] font-[600]'>Guy Hawkins</div>
        ...
        <div className="text-center">
            <img src="/images/person3.png" alt="person" className='mx-auto w-[100px] transform -translate-y-1/2' />
            <div className='-mt-6'>
            <div className='text-[20px] text-[#111029] font-[600]'>Kristin Watson</div>
      ...
      <div className="w-full max-w-[1000px] mx-auto pb-8 bg-white px-3 rounded-xl mt-[100px] flex justify-between gap-5">
        ...
        <div className="text-center">
            <img src="/images/person5.png" alt="person" className='mx-auto w-[100px] transform -translate-y-1/2' />
            <div className='-mt-6'>
            <div className='text-[20px] text-[#111029] font-[600]'>Savannah Nguyen</div>
        ...
        <div className="text-center">
            <img src="/images/person6.png" alt="person" className='mx-auto w-[100px] transform -translate-y-1/2' />
            <div className='-mt-6'>
            <div className='text-[20px] text-[#111029] font-[600]'>Courtney Henry</div>
     ...
     <img src="/images/line2.svg" alt="line" className='absolute top-[900px] left-0 w-full' />
     </div>
    </>
  )
}
